...
exports.bookinstance_create_post = [
    body('book', "Book must be specified").trim().isLength({ min: 1 }).withMessage('Book must be specified').escape(),
...
// Display BookInstance delete from on GET
...
// Deny deletion if book is loaned or reserved
